...
public class Zadanie_1 {
	...
	public void AddProductToBasket() throws Exception {
		...
		System.out.println("Rozpoczynam test: AddProductToBasket functionality");
		...
		System.out.println("Cena w koszyku przed parsowaniem to: " + Price_1_Basket + " zl");
		...
		System.out.println("Cena produktu to: " + Price_Random_Product + " zl");

		Assert.assertEquals(Price_1_Double, Price_Random_Product, random);
		
		System.out.println("Porownanie cen i ich transformacja przebiegla pomyslnie");
	}
	...
	public void UpTo100() throws InterruptedException {
		...
		System.out.println("Rozpoczynam test: UpTo100Products Alert Functionality");
		System.out.println("Rozpoczynam proces zapelniania koszyka wylosowanymi wartosciami na wszystkich produktach: ");
		...
		System.out.println(" - wartosc maksymalna osiagnieta");
